...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="scroll-reveal bg-white/50 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-estuary-sage leading-relaxed">
                  Complete data privacy with local processing. Your conversations and data stay on your device.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="scroll-reveal bg-white/50 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-estuary-sage leading-relaxed">
                  Run entirely without internet and with zero rate limits. Fast, responsive AI that works anywhere, anytime.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="scroll-reveal bg-white/50 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-estuary-sage leading-relaxed">
                  One-time purchase. Lifetime ownership. Your agent keeps working, even if we're no longer around.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="cross-platform" className="relative section-sage">
        {/* Wave divider */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1440 320"
      ...
      {/* Download Section */}
      <section id="download" className="relative section-cream">
        {/* Wave divider */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1440 320"
      ...
      {/* Footer */}
      <footer className="relative section-sage">
        {/* Wave divider */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1440 320"
